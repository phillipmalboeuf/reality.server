...
export default class Model {
  ...
  static list(filters, limit=50, page=0, sort) {
    ...
    delete filters.page
    delete filters.sort
    return this.db.collection(this.collection).find(filters, { limit, skip: page * limit, sort: sort || this.sort }).toArray()
  ...
  static update_where(filters, data) {
    return this.db.collection(this.collection).findOneAndUpdate(filters, { '$set': data }, { returnOriginal: false })
